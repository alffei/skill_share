    ...
    def _initialize(self):
        ...
        try:
            ...
            if "accounts.google.com" in self.page.url:
                raise RuntimeError("Authentication required. Please run python scripts/run.py auth_manager.py setup first.")
...
if __name__ == "__main__":
    # Example usage
    print("Browser Session Module - Use python scripts/run.py ask_question.py for the main interface")
