...
从 references/aws-icons.md 中按服务名检索图标信息。
通过精准提取所需数据，提高 Token 使用效率。
...
def load_icon_data() -> dict[str, dict[str, str]]:
    """从 aws-icons.md 加载图标数据"""
    icons = {}
...
def search_icon(query: str) -> list[dict[str, str]]:
    """搜索与查询关键字匹配的图标"""
