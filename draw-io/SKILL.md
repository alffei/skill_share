...
<!-- SKILL_DIR: This skill's installation directory. Replace with actual path based on your Agent platform. -->
...
bash ${SKILL_DIR}/scripts/convert-drawio-to-png.sh assets/diagram1.drawio
```
...
```sh
python ${SKILL_DIR}/scripts/find_aws_icon.py ec2
python ${SKILL_DIR}/scripts/find_aws_icon.py lambda
```
