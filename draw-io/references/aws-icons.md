...
| Elasticsearch (旧版) | mxgraph.aws4.elasticsearch_service |
...
### 3.8. Machine Learning & AI（机器学习与 AI）
...
### 3.10. Management & Governance（管理与治理）
...
### 3.14. Business Applications（商业应用）
...
可通过 [scripts/find_aws_icon.py](../scripts/find_aws_icon.py) 高效搜索图标。
